    ...
    <div className={styles.policy}>
      ...
      <div className={styles.policy_content}>
        <p>
          ...
          обработки и использования информации, которую Организация может
          получить с устройства во время использования Приложения Пользователем.
          <br />
          <br />
          Использование Приложения означает согласие Пользователя с Политикой и
          указанными в ней условиями обработки и использования информации,
          получаемой с Устройства.
          <br />
          <br />В случае несогласия с условиями Политики, Пользователь должен
        ...
        <div>
          ...
          <p>
            1.3. Персональные данные —информация, прямо или косвенно относящаяся
            к Пользователю, которую он предоставляет в процессе регистрации или
        ...
        <div>
          ...
          <p>
            6.2. Организация имеет право вносить изменения в новых редакциях
            Политики и размещать их на сайте. Обязанность самостоятельного
